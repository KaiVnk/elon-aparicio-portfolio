        ...
        <>
            ...
            <section className="max-w-[1500px] mx-auto pt-[70px] pb-[50px] px-[15px] text-center" id="home">
                <div className='min-h-[40vh] flex flex-col justify-center items-center text-center'>
                    ...
                    <h2 className="text-xl">Investment</h2>
                </div>
            ...
            <section className="max-w-[1500px] mx-auto py-[75px] px-[15px] text-center bg-white">
            ...
            <section className="max-w-[1500px] mx-auto py-[75px] px-[15px] text-center">
